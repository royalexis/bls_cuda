...
def bls(gbls_inputs, time = np.array([0]), flux = np.array([0])):
    ...
    blocks_per_grid_bl = (nper + (threads_per_block - 1)) // threads_per_block
    blocks_per_grid_ph = (npt + (threads_per_block - 1)) // threads_per_block
    blocks_per_grid_du = int( (nb + (threads_per_block - 1)) // threads_per_block )
    print('blocks: ', blocks_per_grid_bl, blocks_per_grid_ph, blocks_per_grid_du)
